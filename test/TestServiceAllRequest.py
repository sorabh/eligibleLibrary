...
import service
import service.ServiceAllRequest as ServiceAllRequest
import unittest

class TestServiceAllRequest(unittest.TestCase):
    def setup(self):
        pass

    def test_responce_isdict(self):
        request= ServiceAllRequest(1,"TEST","Group Health Plan - CMR GROUP HEALTH PLAN (GHP)","184","Thomason","Mark","1928384219","W120923801","Austen","Jane","1955-12-14")
