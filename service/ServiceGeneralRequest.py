...
class ServiceGeneralRequest(RestRequest):
    resource_url="https://gds.eligibleapi.com/v1/service/general.json"
    ...
    def submit(self):	
        responce_obj=self.get_responce(ServiceGeneralRequest.resource_url,self.make_argument())
        return responce_obj
